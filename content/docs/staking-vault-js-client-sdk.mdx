...
The Chaos Finance Staking Vault JavaScript SDK provides a comprehensive interface for integrating Liquid Staking Derivatives (LSD) functionality into your Solana applications.
...
First, register your SONIC network provider and project configuration:

```typescript
import { register, registerWallet } from '@chaosfinance/svm-vault';
