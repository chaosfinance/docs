...
<Callout>
**Note:** In this guide, “Original Token” refers to the asset you deposit (e.g., CHILL), commonly CW20 compatible token, and “LST token” refers to the staked version you receive (e.g., sCHILL).
</Callout>
